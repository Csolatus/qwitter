...
* Points forts : composition API, code clean et modulaire, simple a installer, reactive
* Axes d'amélioration : readme et commentaires de code
* Remarques particulières : documentation pas assez accessible mais projet très bien pour un projet qui est pas encore fini
